...
const Header3: FC<Header3Props> = ({ className = '' }) => {
	...
	const renderButtonOpenHeroSearch = () => {
		return (
			<div
				className={`relative flex w-full items-center justify-between rounded-full border border-neutral-200 shadow transition-all hover:shadow-md dark:border-neutral-600 ${
					showHeroSearch
