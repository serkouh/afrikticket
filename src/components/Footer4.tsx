	...
	return (
		<footer className="border-t border-neutral-200 dark:border-neutral-700">
			<div className="mx-auto max-w-7xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-32">
				...
				<div className="mt-16 border-t border-gray-900/10 pt-8 dark:border-gray-700 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
