...
const SectionSliderNewCategories: FC<SectionSliderNewCategoriesProps> = ({
	...
	// subHeading = 'asdAfrik Ticket is an online ticketing platform from Guinea, designed to simplify the purchase of event tickets and support charitable initiatives through crowdfunding. Focused on accessibility, security, and performance.',
	className = '',
	itemClassName = '',
