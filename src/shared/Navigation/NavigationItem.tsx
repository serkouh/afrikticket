		...
		return (
			<li key={item.id}>
				<Link
					...
					className="inline-flex items-center rounded px-2 py-1 font-normal text-neutral-600 hover:bg-neutral-100 hover:text-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:hover:text-neutral-200"
					href={item.href || ''}
				>
					{item.name}
				</Link>
